...
class SingleitemViewModel extends DefaultChangeNotifier {
  ...
  void trackinginitialSet() {
    ...
    notifyListeners();
    log(trackingcontroller.length.toString());
  }
    ...
    try {
      ...
      if (getpackdetailsData!.orderItemList.length > 1 ||
        ...
        if (getpackdetailsData!.orderItemList[0].itemScanStatusEnum ==
          ...
          log("LENGTH OF THE ORDERITEMLIST${getpackdetailsData!.orderItemList.length}");
          log("QUANITY${getpackdetailsData!.orderItemList.length}");
          if (getpackdetailsData!.orderItemList.length == 1 &&
              getpackdetailsData!.orderItemList[0].quantityorder == "0" &&
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            successSnackBar("UPC# has been scanned successfully"));
        eventLogController.text = 'UPC# has been scanned successfully' +
            '\n' +
            eventLogController.text;
      } else {
        clearController();
